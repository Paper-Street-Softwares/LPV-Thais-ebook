          ...
          <SectionWrapper>
            <div className="max-w-[1215px] flex justify-between">
              <div className="flex flex-col justify-center ">
                ...
                <i>
                  {" "}
                  <p className="font-secondFont text-rolagem w-[50%] text-paragraph1 phone2:text-paragraph2 leading-[15px] phone3:text-paragraph3 tablet1:text-paragraph4 tablet1:w-[65%] tablet2:text-paragraph5 tablet2:leading-[18px] desktop1:w-[80%]">
                    {contentLp01.hero.textArea.subtitle}
                  </p>
                </i>
              </div>
              ...
              <div>
                <img src={contentLp01.hero.bgImg} alt="" />
              </div>
            </div>
          </SectionWrapper>
        </SectionArea>
